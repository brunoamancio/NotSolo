module github.com/brunoamancio/NotSolo

go 1.17

require (
	github.com/iotaledger/goshimmer v0.7.5-0.20210811162925-25c827e8326a
	github.com/iotaledger/hive.go v0.0.0-20210910112237-e00bf1528675
	github.com/iotaledger/wasp v0.1.1-0.20210907130952-2144a817591d
